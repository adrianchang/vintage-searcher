...
export const ARCHETYPES: Record<ArchetypeId, Archetype> = {
  americana: {
    ...
    keywords: [
      ...
      { query: "vintage trucker jacket", percentage: 0.16 },
      { query: "vintage chambray shirt", percentage: 0.15 },
      { query: "vintage CPO shirt", percentage: 0.13 },
      { query: "vintage cruiser jacket", percentage: 0.12 },
      { query: "vintage mackinaw jacket", percentage: 0.15 },
      { query: "vintage tin cloth jacket", percentage: 0.13 },
      { query: "vintage logger jacket", percentage: 0.12 },
      { query: "vintage barn coat", percentage: 0.12 },
      { query: "vintage carpenter pants", percentage: 0.12 },
      { query: "vintage painter pants", percentage: 0.11 },
      { query: "vintage double knee work pants", percentage: 0.11 },
      { query: "vintage engineer cap", percentage: 0.10 },
      { query: "vintage dungarees", percentage: 0.11 },
      { query: "vintage union suit", percentage: 0.10 },
      { query: "vintage shop coat", percentage: 0.11 },
      { query: "vintage mechanic jacket", percentage: 0.12 },
      { query: "vintage filson jacket", percentage: 0.18 },
      { query: "vintage woolrich mackinaw", percentage: 0.16 },
      { query: "vintage pendleton wool shirt", percentage: 0.16 },
      { query: "vintage ben davis overalls", percentage: 0.15 },
    ],
...
In the styleGuide field, speak to how this fits into a rugged, utilitarian Americana wardrobe — raw denim, broken-in boots, chamois shirts. Who wears this naturally?`,
  ...
  ivy: {
    ...
    keywords: [
      ...
      { query: "vintage polo coat", percentage: 0.15 },
      { query: "vintage balmacaan coat", percentage: 0.13 },
      { query: "vintage duffle coat", percentage: 0.14 },
      { query: "vintage repp stripe tie", percentage: 0.12 },
      { query: "vintage club tie", percentage: 0.11 },
      { query: "vintage bow tie", percentage: 0.12 },
      { query: "vintage argyle sweater", percentage: 0.15 },
      { query: "vintage fair isle sweater", percentage: 0.13 },
      { query: "vintage cable knit sweater", percentage: 0.13 },
      { query: "vintage cavalry twill trousers", percentage: 0.12 },
      { query: "vintage madras jacket", percentage: 0.12 },
      { query: "vintage rugby shirt", percentage: 0.14 },
      { query: "vintage gant shirt", percentage: 0.15 },
      { query: "vintage brooks brothers blazer", percentage: 0.17 },
      { query: "vintage j. press sport coat", percentage: 0.16 },
    ],
...
In the styleGuide field, speak to how this fits into a trad wardrobe — khakis, white bucks, rep ties. Who pulls this off without looking costumed?`,
  ...
  military: {
    ...
    keywords: [
      ...
      { query: "vintage N-3B parka", percentage: 0.16 },
      { query: "vintage N-1 deck jacket", percentage: 0.16 },
      { query: "vintage N-2B flight jacket", percentage: 0.14 },
      { query: "vintage L-2B flight jacket", percentage: 0.14 },
      { query: "vintage B-15 flight jacket", percentage: 0.13 },
      { query: "vintage M-51 fishtail parka", percentage: 0.15 },
      { query: "vintage M-43 field jacket", percentage: 0.14 },
      { query: "vintage Ike jacket", percentage: 0.13 },
      { query: "vintage P-44 utility jacket", percentage: 0.12 },
      { query: "vintage CWU-45 flight jacket", percentage: 0.12 },
      { query: "vintage CWU-36 flight jacket", percentage: 0.11 },
      { query: "vintage submarine deck jacket", percentage: 0.12 },
      { query: "vintage OG-107 fatigue shirt", percentage: 0.16 },
      { query: "vintage HBT fatigue jacket", percentage: 0.14 },
      { query: "vintage jungle jacket", percentage: 0.13 },
      { query: "vintage tropical combat jacket", percentage: 0.12 },
      { query: "vintage navy chambray shirt", percentage: 0.14 },
      { query: "vintage navy dungaree shirt", percentage: 0.12 },
      { query: "vintage military mechanic coveralls", percentage: 0.11 },
      { query: "vintage mackinaw coat", percentage: 0.12 },
      { query: "vintage commando sweater", percentage: 0.12 },
      { query: "vintage army wool shirt", percentage: 0.12 },
      { query: "vintage army trench coat", percentage: 0.12 },
    ],
...
In the styleGuide field, speak to how the piece is worn today — the gap between workwear overlap and streetwear. Who wears this well?`,
  ...
  "european-workwear": {
    ...
    keywords: [
      ...
      { query: "vintage le mont saint michel jacket", percentage: 0.15 },
      { query: "vintage le laboureur jacket", percentage: 0.15 },
      { query: "vintage adolphe lafont jacket", percentage: 0.14 },
      { query: "vintage cepovett jacket", percentage: 0.12 },
      { query: "vintage bragard workwear", percentage: 0.11 },
      { query: "vintage SNCF jacket", percentage: 0.13 },
      { query: "vintage PTT jacket", percentage: 0.11 },
      { query: "vintage EDF jacket", percentage: 0.11 },
      { query: "vintage donkey jacket", percentage: 0.16 },
      { query: "vintage british rail donkey jacket", percentage: 0.13 },
      { query: "vintage boiler suit", percentage: 0.13 },
      { query: "vintage barbour international jacket", percentage: 0.15 },
      { query: "vintage wax cotton jacket", percentage: 0.12 },
      { query: "vintage british millerain jacket", percentage: 0.12 },
      { query: "vintage french moleskin trousers", percentage: 0.13 },
      { query: "vintage french salopette", percentage: 0.12 },
      { query: "vintage french work apron", percentage: 0.11 },
      { query: "vintage german blaumann", percentage: 0.11 },
    ],
...
In the styleGuide field, speak to the minimalist, utilitarian aesthetic — how European workwear sits in a wardrobe oriented toward clean silhouettes, natural fabrics, and quiet authenticity.`,
  ...
  cowboy: {
    ...
    keywords: [
      ...
      { query: "vintage stetson cowboy hat", percentage: 0.17 },
      { query: "vintage resistol cowboy hat", percentage: 0.14 },
      { query: "vintage bailey western hat", percentage: 0.13 },
      { query: "vintage miller western wear shirt", percentage: 0.13 },
      { query: "vintage lee 101 western shirt", percentage: 0.13 },
      { query: "vintage levi's big e western shirt", percentage: 0.15 },
      { query: "vintage levi's sawtooth shirt", percentage: 0.13 },
      { query: "vintage wrangler 936 shirt", percentage: 0.14 },
      { query: "vintage ely cattleman shirt", percentage: 0.12 },
      { query: "vintage schaefer outfitter jacket", percentage: 0.12 },
      { query: "vintage nudie suit", percentage: 0.14 },
      { query: "vintage concho belt", percentage: 0.13 },
      { query: "vintage rodeo trophy buckle", percentage: 0.13 },
      { query: "vintage wild rag scarf", percentage: 0.11 },
      { query: "vintage western duster coat", percentage: 0.13 },
      { query: "vintage oilskin duster", percentage: 0.11 },
      { query: "vintage horsehide western jacket", percentage: 0.12 },
      { query: "vintage leather batwing chaps", percentage: 0.11 },
      { query: "vintage western leather vest", percentage: 0.12 },
      { query: "vintage smile pocket western shirt", percentage: 0.11 },
      { query: "vintage shotgun cuff shirt", percentage: 0.11 },
      { query: "vintage chain stitch western shirt", percentage: 0.12 },
    ],
...
In the styleGuide field, speak honestly to who wears vintage western wear today — the overlap between genuine cowboy aesthetic and the fashion-forward take on it.`,
  ...
  biker: {
    ...
    keywords: [
      ...
      { query: "vintage vanson leather jacket", percentage: 0.17 },
      { query: "vintage buco jacket", percentage: 0.16 },
      { query: "vintage langlitz leathers jacket", percentage: 0.15 },
      { query: "vintage lewis leathers jacket", percentage: 0.15 },
      { query: "vintage schott one star jacket", percentage: 0.14 },
      { query: "vintage barbour international jacket", percentage: 0.13 },
      { query: "vintage bates leathers jacket", percentage: 0.13 },
      { query: "vintage hein gericke jacket", percentage: 0.12 },
      { query: "vintage harley davidson leather jacket", percentage: 0.17 },
      { query: "vintage AMF harley davidson jacket", percentage: 0.13 },
      { query: "vintage brooks leather jacket", percentage: 0.12 },
      { query: "vintage excelled leather jacket", percentage: 0.12 },
      { query: "vintage motorcycle racing suit", percentage: 0.13 },
      { query: "vintage motorcycle club vest", percentage: 0.13 },
      { query: "vintage leather biker vest", percentage: 0.12 },
      { query: "vintage leather motorcycle chaps", percentage: 0.11 },
      { query: "vintage leather biker pants", percentage: 0.11 },
      { query: "vintage d-pocket leather jacket", percentage: 0.12 },
      { query: "vintage double rider jacket", percentage: 0.13 },
      { query: "vintage CHP motorcycle jacket", percentage: 0.11 },
      { query: "vintage asymmetric zip leather jacket", percentage: 0.11 },
    ],
...
In the styleGuide field, speak to how a vintage motorcycle jacket actually gets worn today — who wears it authentically and who's costuming.`,
  ...
  reggae: {
    ...
    keywords: [
      ...
      { query: "vintage harrington jacket", percentage: 0.15 },
      { query: "vintage sta prest trousers", percentage: 0.13 },
      { query: "vintage crombie coat", percentage: 0.13 },
      { query: "vintage ben sherman shirt", percentage: 0.14 },
      { query: "vintage fred perry polo", percentage: 0.14 },
      { query: "vintage guayabera shirt", percentage: 0.12 },
    ],
...
In the styleGuide field, speak to the sharp, cool, understated nature of this aesthetic — a style built on contrast and precision.`,
  ...
  "british-mod": {
    ...
    keywords: [
      ...
      { query: "vintage merc polo shirt", percentage: 0.14 },
      { query: "vintage john smedley polo shirt", percentage: 0.13 },
      { query: "vintage john smedley cardigan", percentage: 0.12 },
      { query: "vintage levi's sta-prest jeans", percentage: 0.13 },
      { query: "vintage tonic suit", percentage: 0.14 },
      { query: "vintage mohair suit", percentage: 0.14 },
      { query: "vintage dogtooth check jacket", percentage: 0.12 },
      { query: "vintage crombie coat", percentage: 0.14 },
      { query: "vintage mac coat", percentage: 0.12 },
      { query: "vintage gingham shirt", percentage: 0.11 },
      { query: "vintage knitted tie", percentage: 0.10 },
      { query: "vintage target logo t-shirt", percentage: 0.12 },
      { query: "vintage quadrophenia parka", percentage: 0.13 },
    ],
...
In the styleGuide field, speak to the specific mod aesthetic — slim and precise, built around movement and subcultural clarity. Who wears this in a way that feels lived-in rather than costume?`,
  ...
  rockabilly: {
    ...
    keywords: [
      ...
      { query: "vintage schott perfecto motorcycle jacket", percentage: 0.16 },
      { query: "vintage ricky jacket", percentage: 0.13 },
      { query: "vintage gab jacket", percentage: 0.12 },
      { query: "vintage levi's type 2 jacket", percentage: 0.15 },
      { query: "vintage wrangler 11MJ jacket", percentage: 0.13 },
      { query: "vintage big e levi's jeans", percentage: 0.14 },
      { query: "vintage lee riders jeans", percentage: 0.13 },
      { query: "vintage wabash stripe work pants", percentage: 0.12 },
      { query: "vintage cardigan sweater", percentage: 0.12 },
      { query: "vintage pearl snap western shirt", percentage: 0.12 },
      { query: "vintage bolo tie", percentage: 0.11 },
    ],
...
In the styleGuide field, speak to how this fits into the rockabilly/greaser aesthetic today — the fine line between authentic collector wear and costume.`,
  ...
  sportswear: {
    ...
    keywords: [
      ...
      { query: "vintage puma track jacket", percentage: 0.15 },
      { query: "vintage ellesse tracksuit", percentage: 0.13 },
      { query: "vintage sergio tacchini tracksuit", percentage: 0.13 },
      { query: "vintage fila bj tracksuit", percentage: 0.13 },
      { query: "vintage le coq sportif tracksuit", percentage: 0.12 },
      { query: "vintage reebok windbreaker", percentage: 0.14 },
      { query: "vintage umbro shorts", percentage: 0.13 },
      { query: "vintage umbro soccer jersey", percentage: 0.13 },
      { query: "vintage nike windrunner", percentage: 0.15 },
      { query: "vintage nike blue tag sweatshirt", percentage: 0.14 },
      { query: "vintage adidas firebird track jacket", percentage: 0.13 },
      { query: "vintage russell athletic gold tag sweatshirt", percentage: 0.13 },
      { query: "vintage russell athletic sweatshirt", percentage: 0.13 },
      { query: "vintage rugby shirt", percentage: 0.12 },
      { query: "vintage polo ralph lauren rugby shirt", percentage: 0.14 },
      { query: "vintage varsity jacket", percentage: 0.15 },
      { query: "vintage satin baseball jacket", percentage: 0.13 },
      { query: "vintage mesh basketball jersey", percentage: 0.12 },
      { query: "vintage USA olympic team jacket", percentage: 0.12 },
    ],
